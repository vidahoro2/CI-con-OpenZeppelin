...
contract ContratoConRoles is AccessControl{
    ...
    function soloAdmin()  view public {
        require(hasRole(ROL_ADMIN,msg.sender),"Esta funcion solo puede ser utilizada por el ADMIN");
    }

    function soloUsuario() view public{
        require(hasRole(ROL_USUARIO, msg.sender),"Esta funcion solo puede ser utilizada por el USUARIO");
    }
